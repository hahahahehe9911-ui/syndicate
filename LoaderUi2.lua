...
local fastReeler = loadstring(game:HttpGet("https://raw.githubusercontent.com/hahahahehe9911-ui/syndicate/refs/heads/main/moduls/FastReel.lua"))()
...
--- fast reel
local Fish = makeCategory(mainPage, "Fast Reel Tester", "🎯")
Fish:AddInput({
    Title = "Delay Bait",
